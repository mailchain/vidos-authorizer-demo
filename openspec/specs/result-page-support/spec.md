# result-page-support Specification

## Purpose
Provide users with easy access to support contact options and debugging tools on the authorization result page. This feature enables users to reach out to Vidos whether they encounter issues during the authorization flow or simply want to provide feedback or ask questions. Users can contact support through multiple channels (contact form, GitHub issues) and export comprehensive debugging information to facilitate efficient troubleshooting and support resolution.
## Requirements
