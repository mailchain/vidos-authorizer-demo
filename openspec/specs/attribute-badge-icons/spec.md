# attribute-badge-icons Specification

## Purpose

Defines the visual representation of attribute metadata in the credential request builder's attribute selector using icon-based indicators with an explanatory legend. This specification ensures a compact, scalable UI pattern for displaying attribute constraints (required for issuance, always disclosed) that maintains accessibility and works responsively across device sizes.
## Requirements
