...
- Add copy button next to ID field for easy reference
- The `id` field value becomes the DCQL credential `id`

### Credential Sets Feature
- Add new "Credential Sets" section in UI after credential definitions
...
- Affected code:
  ...
  - `src/components/stages/CreateStage/` - new UI components
